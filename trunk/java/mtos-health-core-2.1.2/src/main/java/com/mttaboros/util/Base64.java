...
/**
 * Base64 convertor class. This code is not a full-blown MIME encoder;
...
public class Base64 {
    ...
    /**
     * Maximum line length of Base64 output. Set to Integer.MAX_VALUE
     */
...
-9,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9         // Decimal 244 - 255 */
    ...
    private static byte[] encode3to4(byte[] threeBytes,
                                     byte[] alphabet) {
        return encode3to4(threeBytes, 3, alphabet);
    }
    ...
    private static byte[] encode3to4(byte[] threeBytes, int numSigBytes,
        ...
        encode3to4(threeBytes, 0, numSigBytes, dest, 0, alphabet);
        return dest;
    }
     ...
     *
     * @param source    The data to convert
     * @param doPadding is <code>true</code> to pad result with '=' chars
