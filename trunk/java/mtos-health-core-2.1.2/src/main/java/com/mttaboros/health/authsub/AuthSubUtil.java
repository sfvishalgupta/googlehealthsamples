...
public class AuthSubUtil {
    ...
    // modified: because health is using a custom authSub url
    ...
    // added extraParams to pass default permission and confidential levels
    ...
    public static String getTokenFromReply(String queryString) {
        ...
        Map/*<String, String>*/ params = StringUtils.string2Map(queryString, "&", "=", true /*stripEntry*/);
    ...
    public static String exchangeForSessionToken(String protocol, String domain, String onetimeUseToken, PrivateKey key) throws IOException, GeneralSecurityException, AuthenticationException {
        ...
        Map/*<String, String>*/ parsedTokens = StringUtils.string2Map(body, "\n", "=", true /*stripEntry*/);
