...
public class HealthClient {
  ...
  public Result createResult(Result result) throws AuthenticationException, IOException {
    ...
    String notice = String.format(NOTICE, "Health App Engine Example App data posted",
        "The Health App Egine Example App posted the following data to your profile:");
